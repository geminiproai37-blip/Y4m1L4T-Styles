...
<html lang="es">
  <head>
    ...
    <link rel="preload" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/Y4m1L4T-Styles@latest/inicio-app/./css/styles.css" as="style" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/Y4m1L4T-Styles@latest/inicio-app/./css/styles.css" media="all" />
    <link
  ...
  <body class="bg-gray-900 text-white">
    ...
    <!-- Facebook SDK for Comments Plugin (from series/index.html and favoritos/inicio-app-app.html) -->
    <div id="fb-root"></div>
    <script>
    ...
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/Y4m1L4T-Styles@latest/inicio-app/./js/script.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/Y4m1L4T-Styles@latest/inicio-app/./js/home.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/Y4m1L4T-Styles@latest/inicio-app/./js/series.js" defer></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/Y4m1L4T-Styles@latest/inicio-app/./js/adultContent.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/Y4m1L4T-Styles@latest/inicio-app/./js/configuracion.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/Y4m1L4T-Styles@latest/inicio-app/./js/aboutAndDMCA.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/Y4m1L4T-Styles@latest/inicio-app/./js/buscador.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/Y4m1L4T-Styles@latest/inicio-app/./js/config.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/Y4m1L4T-Styles@latest/inicio-app/./js/favoritos.js"></script>
